...
The cost function (or loss function) is to minimize the sum of squared error. In that sense, we seek to minimize $$SSE = \sum_{i=1}^{n} \epsilon_i^2 = \sum_{i=1}^{n} (y_i-\beta_0 - \beta_1 x_i)^2$$ {#eq-loss-function} 
