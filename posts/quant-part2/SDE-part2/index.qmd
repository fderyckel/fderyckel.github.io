...
Re-writing @eq-dv1 and factoring the terms in dt and those in $dX_t$, we get: 
$$dV = \left( \frac{\partial V}{\partial t} + 
              ...
              \frac{\partial^2 V}{\partial S_1 \partial S_2} dS_1 dS_2 \right) dt + \left( \sigma_1 S_1\frac{\partial V}{\partial S_1} dX_1 + \sigma_2 S_2\frac{\partial V}{\partial S_2} dX_2 \right)$$
