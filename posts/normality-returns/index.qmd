...
date: "2023-04-19"
categories: [quant-finance, normal-distribution, qq-plot, kurtosis]
editor: source
...
Skewness and Kurtosis are the third and fourth [statiscal moments](../statistical-moments/index.qmd) of a distribution.  

## Skewness 

Ideally, skewness as a measure of symmetry should be close to 0 (perfectly symmetric). 

Let's test the symmetry of our 2 sets of return.  Unfortunately, we did not find any function to calculate skewness in base R (seems strange!).  
