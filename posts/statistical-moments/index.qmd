...
Most statistical packages are providing **excess kurtosis** by subtracting 3 to the kurtosis value. So for a data set that is perfectly normally distributed, we expect the excess kurtosis to be 0. 

There are 3 categories of kurtosis: leptokurtic, mesokurtic (aka normal distribution), platykurtic. 
