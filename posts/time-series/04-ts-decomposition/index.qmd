...
When studying time-series, we can consider trend and seasonality.  In this sense, we could define time-series either in an additive way $$y_t = T_t + S_t + R_t$$ or  in a multiplicative way $$y_t = T_t \cdot S_t \cdot R_t$$ 
...
Let's go back to our milk example 
...
milk |> 
  plot_stl_diagnostics(month, milk_prod_per_cow_kg)
