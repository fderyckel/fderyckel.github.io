...
So let's define a Discrete Random Variable $R_i$ as the i-th toss of a coin.  
...
$$\mathbb{V}ar[S_i] = \mathbb{E}[S_i^2] - \mathbb{E}[S_i]^2 = \mathbb{E} \left[ \sum_{i=0}^{n} R_i^2 \right] = \mathbb{E} \left[ R_0^2 + R_1^2 + \dots + R_n^2 \right] = \mathbb{E}[R_0^2] + \mathbb{E}[R_1^2] + \dots + \mathbb{E}[R_n^2] = 1 + 1 + \dots + 1 = n \cdot 1 = n$$
