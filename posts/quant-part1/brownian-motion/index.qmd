---
title: "Random Walk & Brownian Motions"
...
* as n increases to $/ifty$, both the time and the bets size will decrease to $0$ but not in the same way (by the same order)
* as n increases to $inty$, the random walk stays finite! The random-walk stays continuous everywhere but differentiable nowhere 
